...
VALUES
    ('Abd173', 'Brand A', 'single', 200, 'White', 'High', 'Design', 'Yes', 1, 'Digital'),
    ('B1245v', 'Brand B', 'Double', 300, 'Silver', 'Normal', 'Plane', 'No', 2, 'Analog'),
    ('Dw244', 'Brand C', 'single', 250, 'Black', 'Low', 'Design', 'Yes', 3, 'Digital'),
    ('J3446', 'Brand D', 'Double', 350, 'Steel', 'Low', 'Design', 'No', 1, 'Analog'),
    ('E84H8', 'Brand E', 'single', 280, 'Red', 'High', 'Plane', 'Yes', 2, 'Digital'),
    ('K7h98', 'Brand F', 'Double', 180, 'White', 'Normal', 'Design', 'No', 3, 'Analog'),
    ('H8742', 'Brand G', 'single', 400, 'Silver', 'Low', 'Design', 'Yes', 1, 'Digital'),
    ('YJK242', 'Brand H', 'single', 320, 'Black', 'Normal', 'Plane', 'No', 2, 'Analog'),
    ('W46f5', 'Brand I', 'Double', 230, 'Steel', 'High', 'Plane', 'Yes', 3, 'Digital'),
    ('F35fe', 'Brand J', 'single', 380, 'Red', 'Normal', 'Design', 'No', 1, 'Analog'),
    ('K757f', 'Brand K', 'single', 260, 'White', 'Low', 'Plane', 'Yes', 2, 'Digital'),
    ('MA647', 'Brand L', 'Double', 200, 'Silver', 'Normal', 'Design', 'No', 3, 'Analog'),
    ('J865y', 'Brand M', 'single', 330, 'Black', 'High', 'Design', 'Yes', 1, 'Digital'),
    ('Sg375', 'Brand N', 'Double', 270, 'Steel', 'Normal', 'Plane', 'No', 2, 'Analog'),
    ('Q23gt', 'Brand O', 'single', 210, 'Red', 'Normal', 'Design', 'Yes', 3, 'Digital'),
    ('B34t5', 'Brand P', 'Double', 390, 'White', 'Normal', 'Design', 'No', 1, 'Analog'),
    ('Q24rf', 'Brand Q', 'single', 240, 'Silver', 'High', 'Plane', 'Yes', 2, 'Digital'),
    ('HT9876', 'Brand R', 'Double', 180, 'Black', 'High', 'Plane', 'No', 3, 'Analog'),
    ('Qs312', 'Brand S', 'single', 400, 'Steel', 'Low', 'Design', 'Yes', 1, 'Digital'),
    ('L927d', 'Brand T', 'Double', 320, 'Red', 'High', 'Plane', 'No', 2, 'Analog');
